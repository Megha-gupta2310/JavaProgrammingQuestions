...
public class MaximumDistinctCharacters { 
	
	/*
	 * Input : "AABBBCBB" Output : 5
	 * 
	 * Input : "AABBBCBBAC" Output : 3 Explanation : Sub-string -> "BAC"
	 * 
	 * Input : "GEEKSGEEKSFOR" Output : 8 Explanation : Sub-string -> "GEEKSFOR"
	 */
